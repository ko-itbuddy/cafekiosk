...
class OrderStatisticsServiceTest {
    ...
    void sendOrderStatisticsMail() {
        ...
        Order order1 = creataCompletedOrder(LocalDateTime.of(2023, 3, 4, 23, 59), products);
        Order order2 = creataCompletedOrder(now, products);
        Order order3 = creataCompletedOrder(LocalDateTime.of(2023, 3, 5, 23, 59), products);
        Order order4 = creataCompletedOrder(LocalDateTime.of(2023, 3, 6, 0, 0), products);
    ...
    private Order creataCompletedOrder(LocalDateTime now, List<Product> products) {
